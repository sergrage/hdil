    ...
    <div class="d-flex justify-content-around align-items-center">
      ...
      <div class="mobile_menu">
        ...
        <ul class="nav nav-auth">
            ...
            <li class="nav-item pl-4"><a class="nav-link header__cabinet-link" href="{{ route('fillprofile.edit') }}"> <i class="far fa-edit"></i> Edit profile </a></li>
            <li class="nav-item pl-4"><a class="nav-link header__cabinet-link border-white-none" href="{{ route('messages.index') }}"><i class="far fa-comment"></i> Messages @include('messenger.unread-count')</a></li>
            @can('admin-panel')
