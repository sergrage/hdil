...
<div class="bg-light border-right" id="sidebar-wrapper">
  <div class="sidebar-heading text-center">{{$user->firstname}} {{$user->lastname}} <span class="badge badge-info" style="margin: auto auto auto 0; opacity: 0.5;">online</span></div>
    ...
    <a href="{{route('cabinet.home')}}" class="list-group-item list-group-item-action bg-light border-right-0"><i class="fas fa-home"></i> Cabinet</a>
    ...
    <a href="{{ route('messages.index') }}" class="list-group-item list-group-item-action bg-light border-right-0"><i class="far fa-comment"></i> Messages @include('messenger.unread-count') </a>
    <a href="{{ route('community') }}" class="list-group-item list-group-item-action bg-light border-right-0"><i class="fas fa-user-friends"></i> Community </a>
