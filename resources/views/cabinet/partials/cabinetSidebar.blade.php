<div class="col-xl-2 col-lg-3 col-md-4 d-none d-md-block bg-light cabinet-sidebar">
	<div class="sidebar-sticky">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link cabinet-sidebar__link" href="{{ route('messages.index') }}"><i class="far fa-comment"></i> Message</a>
	     </li>
          <li class="nav-item">
