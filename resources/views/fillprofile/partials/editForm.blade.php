                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                        <div class="input-group mb-2">
                            ...
                            <input name="facebook" type="text" class="form-control"  placeholder="Add your facebook page" style="height:inherit">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="input-group mb-2">
                        ...
                        <input name="twitter" type="text" class="form-control" placeholder="Add your twitter page" style="height:inherit">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="input-group mb-2">
                        ...
                        <input name="linkedin" type="text" class="form-control" placeholder="Add your linkedin page" style="height:inherit">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="input-group mb-2">
                        ...
                        <input name="instagram" type="text" class="form-control" placeholder="Add your instagram page" style="height:inherit">
                        </div>
                    </div>
                    </div>
                </div>
